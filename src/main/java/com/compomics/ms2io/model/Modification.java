...
public class Modification implements Serializable {
    ...
    private final char aaSymbol;
    private final double massShift;
    private final String UNIMODE_id;
    private String mod_as_str = "";

    public Modification(String modstr) {
        this.mod_as_str = modstr;

        this.aaSymbol = Character.MAX_VALUE;
        this.mode_name = "";
        this.position = 0;
        this.massShift = 0;
        this.UNIMODE_id = "";
    ...
    public Modification(int pos, char aa, String name) {
        this.aaSymbol = aa;
        this.mode_name = name;
        this.position = pos;
    ...
    public Modification(int pos, char aa, double massShift) {
        this.aaSymbol = aa;
        this.position = pos;
    ...
    public Modification(int pos, char aa, double massShift, String unimodeId) {
        this.aaSymbol = aa;
        this.position = pos;
        this.massShift = massShift;
        this.mode_name = "";
    ...
    public Modification(int pos, char aa, String name, String unimodeId) {
        this.aaSymbol = aa;
        this.position = pos;
        this.massShift = 0;
        this.mode_name = name;
    ...
    public String getModification_str(){
        return this.mod_as_str;
    }
